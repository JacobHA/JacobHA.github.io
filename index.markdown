...
<p align="center">
and compositionality, transfer, or curriculum learning:
...
<div align="center">
  <a href="/research/" target="_blank" style="
    display: inline-block;
    background: linear-gradient(90deg, #c03a15ff 0%, #369768ff 100%);
    color: #fff;
    font-size: 2rem;
    font-weight: bold;
    padding: 2rem 3rem;
    border-radius: 16px;
    box-shadow: 0 6px 24px rgba(63,159,223,0.15);
    text-decoration: none;
    transition: transform 0.2s, box-shadow 0.2s;
  " onmouseover="this.style.transform='scale(1.05)';this.style.boxShadow='0 12px 32px rgba(63,159,223,0.25)';" onmouseout="this.style.transform='scale(1)';this.style.boxShadow='0 6px 24px rgba(63,159,223,0.15)';">
    📝 Visualization of papers and their connections 🔗
  </a>
</div>
<p>
<p>
  ...
  <ul class="timeline-list">
    {% for item in site.data.announcements %}
      <li>
        ...
        <div class="content" data-date="{{ item.date }}">
          <p>{{ item.text }}</p>
        </div>
      </li>
    {% endfor %}
...
<div class="timeline">
  <h2 style="font-size:2rem; font-weight:bold;">Recent Announcements</h2>
  <ul class="timeline-list">
    {% for item in site.data.announcements %}
      <li class="timeline-entry {% if forloop.index > 5 %}hidden{% endif %}">
        <div class="timeline-item">
          <div class="dot"></div>
        </div>
        <div class="content" data-date="{{ item.date }}">
  ...
  <center>
  <button id="show-more-btn" class="show-more" style="font-size:1.1rem; font-weight:bold;">Show More</button>
  </center>
</div>
